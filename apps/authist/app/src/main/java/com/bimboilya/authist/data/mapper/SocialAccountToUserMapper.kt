...
class SocialAccountToUserMapper @Inject constructor(
    ...
    private val yandexUserMapper: YandexUserMapper,
) {
    ...
    fun map(account: SocialAccount): User =
        when (account) {
            ...
            is Yandex -> yandexUserMapper.map(account)
        }
}
